---
title: Creating a Data Management Plan on DMPonline
toc: true
---
...
**Enter project title** > Short but descriptive title

**Your organisation's templates** > Select the template based on funder requirements (if no funder, select the TU Delft template)

:::{.callout-important collapse="true"}
## Is the DMP for an HREC application? (expand)

If you are creating a DMP for an HREC application you are required to use TU Delft Data Management Plan template (2025)

You will still be able to indicate the funder in the Project details section of the DMP.

![](/img/DMPonline-select-plan.png)
:::

When you have selected a template, click 'Create' at the bottom of the page.
...
![Q1: 'This DMP is created during the Data Management Plan Training for ME PhD students delivered by my faculty data steward {{< var instructor.name >}}' <br> Q2: the date of the training.](/img/DMPonline-write-plan.png)
...
![](/img/DMPonline-request-feedback.png)
...
![Project details includes the abstract, ID, funder, etc.](/img/DMPonline-download.png)
